...
import com.pinatafarms.app.persondetails.PersonDetailsViewModel
...
import com.pinatafarms.data.source.image.PersonFaceVisualizationDataSourceImpl
...
import com.pinatafarms.domain.usecases.PersonFaceVisualizationUseCaseImpl
...
val useCasesModule = module {
    ...
    single<PersonFaceVisualizationUseCase> { PersonFaceVisualizationUseCaseImpl(get()) }
}
...
val dataSourcesModule = module {
    ...
    single<PersonFaceVisualizationDataSource> { PersonFaceVisualizationDataSourceImpl(get(), get()) }
